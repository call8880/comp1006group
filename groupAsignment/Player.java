...
public abstract class Player {
	 ...
	 * 
	 * @param newLocation
	 *            is the new location that the player will be moved to
	 * @return true if the move was successful and false otherwise (e.g. when trying
	 *         to move from one location to another that are not connected)
	 */
	 ...
	 * 
	 * @param location
	 *            is the Location to set for the player
	 */
	 ...
	 * 
	 * @param h
	 *            is the new health of the player
	 */
	 ...
	 * 
	 * @param t
	 *            isa thing to add to the player's list of things
	 */
	 ...
	 * 
	 * @param t
	 *            is a thing to be removed from the player's list of things
	 * @return true if remove was successful and false otherwise (i.e., if the
	 *         player does not have this thing in their list).
	 */
	 ...
	 * 
	 * @param g
	 *            is the new goal for this player
	 ...
	 * 
	 * @param p
	 *            is a player that is interacting with this player
	 */
	 ...
	 * 
	 * @param t
	 *            is a thing that this player is interacting with
	 */
