...
public class Location {
	...
	/**
	 * Checks if another location is adjacent (connected with a door) to this
	 * current location.
	 * 
	 * @param other
	 *            is another location
	 * @return true if this location and the other location are adjacent to each
	 *         other (connected with a door)
	 */
	 ...
	 * 
	 * TODO: This will throw an ArrayIndexOutOfBoundsException You need to deal with
	 * this in some way.
	 */
	...
	/**
	 * Two locations are equal to each other if they are in the same world, have the
	 * same row and column.
	 */
	@Override
	public boolean equals(Object o) {
		if (o instanceof Location) {
			return this.row == ((Location) o).row && this.col == ((Location) o).col
