...
public class Thing {
	...
	/**
	 * Allows for a Thing to interact with the room it is in (including all of the
	 * players and things in that room)
	 */
	 ...
	 * 
	 * @param p
	 *            is a player that is interacting with this current thing
	 */
	...
	public boolean equals(Object o) {
		if (o instanceof Thing) {
			return this.name.equals(((Thing) o).name) && this.location.equals(((Thing) o).location)
					&& this.value == ((Thing) o).value && this.extraField == ((Thing) o).extraField;
