...
public class World{
    ...
    public World(String worldFileName){
        ...
        playersList.add(3, new Thief(this, "Thief", new Location(this, 0, 0), 100, new java.util.ArrayList<Thing>(), new GoldenIdol("Thing", new Location(this, 0, 0), 1)));
        ...
        thingList.add(3,new Rock(new Location(this,0,0),0));
